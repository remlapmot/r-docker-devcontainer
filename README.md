...
To use the devcontainer in an OS project copy the *.devcontainer* directory (with its contents) to the root of your OS project.

When you open this or your project in VSCode
